...
function displayTransactionTable(userData) {
    ...
    transactions.forEach(transaction => {
        ...
        document.querySelector("tbody").innerHTML += `
        <tr title="View more details about your transaction" onclick="window.location.href='transaction?id=${transaction.id}&token=${localStorage.token}'" class="${type.toLowerCase()} recurring-${transaction.recurring}">
